...
export default class Hikes {
    ...
    // This also sets me up nicely if my data were to move. I can just change this 
    // method to the new source and everything will still work if I only access the data through this getter.
    getAllHikes() {
        return hikeList;
    }
    ...
    showHikeList() {
        ...
        // notice that we use our getter above to grab the list instead of getting it directly...
        // this makes it easier on us if our data source changes...
    ...
    addHikeListener() {
        ...
        // remember though that children is a nodeList...not an array. So in order to use something 
        // like a forEach we need to convert it to an array.
        ...
        childrenArray.forEach(child => {
            child.addEventListener('touchend', eventFunction);
            child.addEventListener('click', eventFunction);
        });
    ...
    buildBackButton() {
        ...
        backButton.addEventListener('touchend', eventFunction);
